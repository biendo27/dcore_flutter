...
//* Export all dart library here
export 'dart:async';
export 'dart:convert';
export 'dart:io';
export 'dart:math';

//* Export all dependencies here
...
export 'package:smooth_page_indicator/smooth_page_indicator.dart' hide ScaleEffect, SwapEffect, SlideEffect;
