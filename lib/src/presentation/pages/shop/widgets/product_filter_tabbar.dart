...
class ProductFilterTabbar extends StatelessWidget {
  final TabController tabController;
  const ProductFilterTabbar({super.key, required this.tabController});
  ...
  Widget build(BuildContext context) {
    return TabBar(
      ...
      onTap: (index) => context.read<ProductFilterCubit>().searchProduct(sortOption: SortOption.values[index]),
      tabs: [
